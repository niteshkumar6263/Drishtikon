...
DISPLAY_WIDTH = 1500  # Reduced from 800 for better CPU performance
DISPLAY_HEIGHT = 940  # Reduced from 600 for better CPU performance
    ...
    try:
        ...
        if left_lines and right_lines:
            ...
            if abs(center_x - mid_point) < 30:
                ...
                return frame, "Shift Left"
            else:
                return frame, "Shift Right"
